...
<head>
    ...
    <title>Edit User - PustakaKu Admin</title>
                        ...
                        <form method="POST" id="editUserForm" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role" name="role" required>
                                    ...
                                    <option value="member" <?php echo ($selected_role == 'member') ? 'selected' : ''; ?>>Member</option>
                                </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Note:</strong> Password cannot be changed through this form. Users must reset their password separately.
                            </div>
